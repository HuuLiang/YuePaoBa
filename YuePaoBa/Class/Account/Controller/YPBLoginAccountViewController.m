//
//  YPBLoginAccountViewController.m
//  YuePaoBa
//
//  Created by Liang on 16/5/23.
...
@interface YPBLoginAccountViewController () <UITextFieldDelegate>
{
...
@implementation YPBLoginAccountViewController
...
- (void)initEnterBtn {
    YPBActionButton *nextButton = [[YPBActionButton alloc] initWithTitle:@"确认登录" action:^(id sender) {
        [self login];
    }];
