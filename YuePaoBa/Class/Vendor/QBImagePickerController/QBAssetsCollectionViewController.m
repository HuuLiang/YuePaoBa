...
- (CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout *)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    const CGFloat width = (CGRectGetWidth(collectionView.bounds)-(itemsPerRow+1)*flowLayout.minimumInteritemSpacing) / itemsPerRow;
...
{
    UICollectionViewFlowLayout *flowLayout = (UICollectionViewFlowLayout *)collectionViewLayout;
    return UIEdgeInsetsMake(flowLayout.minimumInteritemSpacing, flowLayout.minimumInteritemSpacing, flowLayout.minimumInteritemSpacing, flowLayout.minimumInteritemSpacing);
}
