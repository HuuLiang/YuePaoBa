...
#define YPB_CHANNEL_NO   @"QB_MFW_IOS_F_00000001"
...
#define YPB_BASE_URL                    @"http://mfw.ihuiyx.com"
...
#define YPB_PAYMENT_COMMIT_URL          @"http://pay.iqu8.net/paycenter/qubaPr.json"
